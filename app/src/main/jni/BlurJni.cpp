...
void JNICALL Java_com_android_music_Utils_BlurJNI_initCBlur1(JNIEnv *env,
                                                             jobject obj,
                                                             jintArray pix,
                                                             jint w,
                                                             jint h,
...
void JNICALL Java_com_android_music_Utils_BlurJNI_initCBlur2(JNIEnv *env,
                                                             jobject obj,
                                                             jintArray pix,
                                                             jint w,
                                                             jint h,
